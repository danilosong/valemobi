      ...
      <table>
         ...
         <form action="?acao=up" method="post">
            <tfoot>
               ...
               <tr>
                  <td colspan="5"><a href="compra.php">Continuar Comprando</a></td>
            </tfoot>
            <tbody>
               <?php
                  ...
                  ';
                     ...
                     foreach($_SESSION['carrinho'] as $id => $qtd){
                           $sql   = mysqli_query ($conn,"SELECT * FROM produto where COD_PROD = '".$id."'");
          
                           $ln    = mysqli_fetch_assoc($conn, $sql);	
                            
                           $nome  = $_POST['nome_produto'];
                           $preco_produto = $_POST['preco_produto'];
                           $sub   = $_POST['preco_produto'] * $qtd;
